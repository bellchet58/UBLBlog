		...
		<div class="main">
			...
			<div class="content">
				...
				<div class="article">
					<div class="con">
						<h2 class="con-title">
							<a target="_blank" href="${rc.contextPath}/article/read?id=${article.id}">
								${article.title}
							</a>
						</h2>
						<div class="con-txt">
					...
					<div class="info">
						...
						<a class="date"  href="${rc.contextPath}/article/read?id=${article.id}&flag=cmt">评论(${article.commentCount})</a>
						<#if article.tags?exists && (article.tags?size>0)>
						<span>
							<#list article.tags as tag>
								<a href="${rc.contextPath}/article/list?tagId=${tag.id}">${tag.name}</a>
							</#list>
						</span>		
						</#if>
					</div>
				...
				<!--分页 -->
			   	<div class="page">
		            <#if page?exists> 
		            <form id="form" action="${rc.contextPath}/article/index" method="post">
