...
<body style="background:none">
	...
	<div class="ope-area">
		...
		<div class="edit-new">
			<div class="title">
				<form class="form-search" action="${rc.contextPath}/admin/article/search">
		   ...
		   <div class="page">
	            <#if page?exists> 
	            <form id="form" action="${rc.contextPath}/admin/articles" method="post">
	    			<input type="hidden" name="currentPage" id="currentPage" value="${page.pageNum}"></input>
